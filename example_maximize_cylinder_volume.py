...
#A example program that maximizes the volume of a 3d cylinder, given a
...
def calculate_surface_area(genome):
  top_and_bottom_area = 2.0*(math.pi*genome[0]*genome[0])
  side_area = (2.0*math.pi*genome[0])*genome[1] 
  return top_and_bottom_area + side_area

#genome[0] is the radius, genome[1] is the height
def calculate_volume(genome):
  return math.pi*genome[0]*genome[0]*genome[1]
